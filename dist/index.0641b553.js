...
const getCountries = async (searchString)=>{
    ...
    try {
        const response = await (0, _axiosDefault.default).get(`https://restcountries.com/v2/name/${searchString}`);
        ...
        const currencyCheck = (numberOfCurrencies)=>{
            if (numberOfCurrencies === 1) {
                ...
                const countryValuta1 = document.createElement("p");
                countryValuta1.textContent = `The capital is ${capital} and you can pay in ${currencyName} and in ${currencyName2}`;
                searchContainer.appendChild(countryValuta1);
...
},{}]},["7Aums","bNKaB"], "bNKaB", "parcelRequire5e27")
